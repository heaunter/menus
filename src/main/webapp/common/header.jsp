...
<header class="am-topbar am-topbar-inverse admin-header">
	<div class="am-topbar-brand">
		<a href="javascript:;" class="tpl-logo"> <img
			src="${ctx}/resources/images/logo.jpg" alt=""> </a>
	</div>
	<div
	...
	<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
		...
		<ul
			...
			<li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
				...
				href="javascript:;"> <span class="tpl-header-list-user-nick">${session_user.name
						}</span> </a>
				<ul class="am-dropdown-content" style="display: none;">
					<li><a href="#"><span class="am-icon-bell-o"></span> 资料</a>
					</li>
			...
			<li><a href="${ctx}/user/logout" class="tpl-header-list-link"><span
					class="am-icon-sign-out tpl-header-list-ico-out-size"></span> </a>
			</li>
		</ul>
	</div>
</header>