					...
					<li class="tpl-left-nav-item"><a href="javascript:;"
						...
						<ul class="tpl-left-nav-sub-menu" style="display: block;">
							<li><a href="${ctx}/report/prepare"> <i
								...
								href="${ctx}/report/delivery/summary" class="active"> <i
			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span> 配送汇总
					</div>
				</div>
				<p style="font-size: 14px;margin-left: 20px; margin-bottom: 5px;">
					<span style="font-weight: bolder;">当前选择病区: </span>${areaNames}
				</p>
				<div class="tpl-block">
					<div class="am-g" style="height: 50px;">
						<form action="${ctx}/report/delivery/summary" method="get">
							<div class="am-u-sm-12 am-u-md-2">
								<div class="am-form-group">
									<input type="text" name="date" value="${date}"
										class="am-form-field tpl-form-no-bg" placeholder="请选择时间……"
							...
							<div class="am-u-sm-12 am-u-md-3">
								<div class="am-input-group am-input-group-sm">
									...
									<span class="am-input-group-btn" style="width: auto;"> <a
										href="${ctx}/report/delivery/summary/print?date=${date}&period=${period}&areaNo=${areaNo}"
										target="_blank"
										class="am-btn am-btn-default am-btn-success tpl-am-btn-success am-icon-print"
										type="button"> 打印</a> </span>
								</div>
							</div>
						</form>
					</div>
										...
										<c:forEach items="${prepareReport }" var="re">
											<tr>
												...
												<td class="am-hide-sm-only"><fmt:formatDate
														pattern="yyyy-MM-dd" value="${re.datetime }" /></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
