			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span> 修改种类
					</div>
				</div>
				<div class="tpl-block ">
					<div class="am-g tpl-amazeui-form">
						<div class="am-u-sm-12 am-u-md-9">
							<form action="${ctx}/meal/category/${category.id}/update"
								method="post" class="am-form am-form-horizontal">
								<div class="am-form-group">
									<label for="id" class="am-u-sm-3 am-form-label">种类主键 </label>
									<div class="am-u-sm-9">
								...
								<div class="am-form-group">
									<label for="name" class="am-u-sm-3 am-form-label">种类名称
									</label>
									<div class="am-u-sm-9">
										<input type="text" id="name" name="name"
											value="${category.name }" placeholder="种类名称...">
									</div>
								</div>
								<div class="am-form-group">
									<label for="sort" class="am-u-sm-3 am-form-label">排序码 </label>
									<div class="am-u-sm-9">
										<input type="number" id="sort" name="sort"
											value="${category.sort }" placeholder="请输入排序码..."> <small
											class="am-text-danger">注意：排序码越小，排名越靠前</small>
									</div>
								</div>
								<div class="am-form-group">
									<label for="time" class="am-u-sm-3 am-form-label">修改时间
									</label>
									<div class="am-u-sm-9">
										<input type="datetime" readonly id="time" name="time"
											value="${category.updateTime }">
									</div>
								</div>
								<div class="am-form-group">
